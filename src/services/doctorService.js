        ...
        try{
            ...
            if(checkObj.isValid === false){
               ...
               if (doctorInfor){
                   ...
                   //create
                   console.log('hi',inputData.specialtyId)
...
let getDetailDoctorById1 = (inputId) => {
    return new Promise(async(resolve, reject) => {
        try{
            if(!inputId){
                resolve({
                    errCode:1,
                    errMessage:'Missing requite parameter !'
                })
            }else{
...
let getSpecialTop = () => {
    return new Promise(async(resolve, reject) => {
        try {
            let dataSpecial = db.specialty.findAll({
                raw: true,
            })
            resolve(dataSpecial)
        }catch(err){
...
let getDetailSpecial = (inputdata) => {
    return new Promise(async(resolve, reject) => {
        try{
            if(!inputdata){
                resolve({ 
                ...
                let DetailSpecial = db.specialty.findOne({
                    where: {
                        name: inputdata
                    },
                    raw: false
                })
                resolve(DetailSpecial)
            }
...
module.exports = {
    ...
    getDetailDoctorById1:getDetailDoctorById1,
